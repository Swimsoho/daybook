...
export function seedState(): AppState {
  return {
    ...
    tasks: [
      ...
      { id: 't13', title: 'Chase RSVPs from committee list', type: 'followup', parentId: 't10', areaId: 'a_shul', projectId: 'pr_dinner', categoryIds: ['c_events', 'c_followup'], priority: 'P1', status: 'next', due: addDays(T, 2), source: 'manual', created: daysAgo(10) },
      ...
      { id: 't21', title: 'Buy tickets for the school play', type: 'todo', areaId: 'a_family', categoryIds: ['c_errand'], priority: 'P2', status: 'next', due: addDays(T, 3), source: 'whatsapp', created: daysAgo(1) },
      ...
      // Work
      { id: 't30', title: 'Chase invoice #204 — Brightside Ltd', type: 'followup', areaId: 'a_work', projectId: 'pr_invoicing', categoryIds: ['c_money', 'c_followup'], priority: 'P1', status: 'next', due: daysAgo(2), source: 'manual', created: daysAgo(9) },
      ...
      { id: 't32', title: 'Call David re school governor intro', type: 'call', areaId: 'a_work', personId: 'p_david', categoryIds: ['c_call'], priority: 'P1', status: 'next', due: T, source: 'whatsapp', callAbout: 'He offered an intro to the governors — take him up on it', created: daysAgo(2) },
      { id: 't33', title: 'Send Sarah the article you promised', type: 'followup', areaId: 'a_work', personId: 'p_sarah', categoryIds: ['c_followup'], priority: 'P1', status: 'next', due: daysAgo(1), source: 'manual', created: daysAgo(6) },
      ...
      // Done recently
      { id: 't60', title: 'Book dentist for the kids', type: 'todo', areaId: 'a_family', categoryIds: ['c_errand'], priority: 'P2', status: 'done', source: 'whatsapp', created: daysAgo(9), completedAt: daysAgo(1) },
    ...
    categories: [
      { id: 'c_call', name: 'Call', level: 0, active: true, color: 'hsl(215 45% 42%)' },
      { id: 'c_errand', name: 'Errand', level: 0, active: true, color: 'hsl(40 65% 42%)' },
      ...
      { id: 'c_followup', name: 'Follow-up', level: 0, active: true, color: 'hsl(17 63% 47%)' },
