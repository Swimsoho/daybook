...
export function seedState(): AppState {
  return {
    ...
    trackers: [
      ...
      {
        id: 'trk_dates', collectionId: 'col_dates', name: 'Dates to Remember', description: 'Birthdays, anniversaries, and other dates worth a nudge — export to your calendar from Collections',
